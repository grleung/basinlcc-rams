...
#############################################################################
RAMS_ROOT=/home6/grleung1/basinlcc-rams
RAMS_VERSION=6.3.02
...
#############################################################################
HDF5_ROOT=/home6/grleung1/misc/hdf5-1.10.8-build
# ZFP ROOT only needed if gcc compiler flag '-DENABLE_ZFP_COMPRESSION' is used
H5Z_ZFP_ROOT=/home6/grleung1/misc/H5Z-ZFP-build# For ZFP Compression
