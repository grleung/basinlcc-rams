...
integer, parameter ::  &
 ...
 ,nxpmax       = 5000  & ! Max # of points in x-direction
 ,nypmax       = 5000  & ! Max # of points in y-direction
 ...
 ,maxdim       = 5000  & ! Largest of NXPMAX,NYPMAX,NZPMAX+10,NZGMAX
 ...
 ,maxmach      = 9999  & ! Max # of parallel processors
