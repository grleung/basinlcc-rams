...
subroutine rte_rrtmgp_init()
  ...
  call stop_on_err(gas_concs%set_vmr('co2', 300.e-6)) !GRL 2024-03-10 note that this is the same as what is assumed in Harrington code -- sadly no longer realistic
