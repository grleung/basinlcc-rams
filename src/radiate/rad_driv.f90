...
! carbon dioxide
! GRL edited CO2 concentration to be consistent with Harrington 2024-03-10
...
u(1,2) = .5 * (dl(2) + dl(1)) * .4558-3 * 9.81 * dzl(1)
...
do k = 2,nrad
   ...
   !GRL edited CO2 profile for Harrington 2024-03-10
